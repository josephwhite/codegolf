...
xref:challenges/yes.ps1[yes.ps1]
...
xref:challenges/4billionifs.ps1[4billionifs.ps1]
...
xref:challenges/incremental-game-datetime.ps1[incremental-game-datetime.ps1]
...
xref:challenges/PowXn.ps1[PowXn.ps1]
...
xref:challenges/valid-phone-numbers.ps1[valid-phone-numbers.ps1]
...
xref:challenges\12hr-to-24hr.ps1[12hr-to-24hr.ps1]

=== challenge

https://codegolf.stackexchange.com/questions/105858/[Stack Exchange]

=== requirements

* Input as HH:MM am/pm.
** The space separating the am/pm from the rest of the time is optional.
** Can either be "am"/"pm", or "a"/"p".
** Any capitalization is fine.
* Midnight can be either 0000/2400, must be AM.
* Noon is PM.
...
See xref:tests/12hr-to-24hr.Tests.ps1[test file].
